...
public class AbstractDAO<T> {
    ...
    /**
     * Metoda care creeaza o lista de obiecte de tipul corespunzator tabelelor respective
     *
    ...
    private String createInsertQuery() {
        ...
        String str = "INSERT INTO `" + type.getSimpleName() + "`";
        str += " VALUES (";
    ...
    private String createUpdateQuery() {
        ...
        String str = "UPDATE `" + type.getSimpleName() + "` SET ";

        Field[] fields = type.getDeclaredFields();
        int nrAtribute = fields.length;

        for (int i = 0; i <= nrAtribute - 3; i++) {

            str += fields[i + 1].getName() + " = ?, ";
        }

        str += fields[nrAtribute - 1].getName() + " = ? WHERE id = ?";
    ...
    public T insert(T t) {
        ...
        try {
            ...
            for (Field f : type.getDeclaredFields()) {
                ...
                } else if (f.get(t) instanceof Double) {

                    statement.setDouble(index, (Double) f.get(t));
                }
        ...
        try {
            ...
            for (int i = 1; i <= fields.length - 1; i++) {
                ...
                if (fields[i].get(t) instanceof Integer) {
                    ...
                    statement.setDouble(index, (Double) fields[i].get(t));
                }
